 ...
 * <p>
 * Methods are called from the {@link org.lcsim.job.JobControlManager} in the
 * following order.
 * <nl>
 * <li>{@link #configure()} - configure conditions system before it is
 * initialized
 * <li>{@link org.lcsim.job.ConditionsSetup#setup()} - possibly initialize
 * conditions system with detector and run
...
public interface ConditionsSetup {
    ...
    /**
     * Rewrite detector name.
     * 
     * @param rewriteDetectorName True to rewrite detector name
     */
    void setRewriteDetectorName(boolean rewriteDetectorName);
}
