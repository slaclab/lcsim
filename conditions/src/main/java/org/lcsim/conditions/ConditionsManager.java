...
public abstract class ConditionsManager {
     ...
     * @throws org.lcsim.conditions.ConditionsManager.ConditionsNotFoundException If the conditions
     * associated with this detector/run number can not be found.
     */
     ...
     */
    public abstract <T> CachedConditions<T> getCachedConditions(Class<T> type, String name)
    ...
    /**
     * Enable rewriting of detector name in event header.
     * 
     * This is just a flag for the event header class to utilize.
     * 
     * @param rewriteDetectorName True if rewriting of detector name should be enabled
     */
    public abstract void setRewriteDetectorName(boolean rewriteDetectorName);

    /**
     * Get whether rewriting of the detector name is enabled.
     * 
     * @return True if rewriting the detector name is enabled
     */
    public abstract boolean getRewriteDetectorName();
